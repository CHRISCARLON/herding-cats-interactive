...
class CommandButton(Button):
    ...
    def __init__(
        self,
        explorer: Optional[
            CkanCatExplorer | OpenDataSoftCatExplorer | FrenchGouvCatExplorer
        ] = None,
        **kwargs,
    ):
    ...
    def _format_commands_list(self) -> Text:
        ...
        # Helper functions
        def _add_command_section(
            commands: list[tuple[str, str]], header: str | None = None
        ):
            if header:
        ...
        match self.explorer:
            case CkanCatExplorer():
                ...
                _add_command_section(
                    [
                        ...
                        (
                            "search <query> <rows>",
                            "Search packages with query and limit results",
                        ),
                        ("list orgs", "Show all organizations in the catalog"),
                        (
                            "load <id> <format>",
                            "Load a data sample into a DataFrame with an optional format specified",
                        ),
                    ],
                    "CKAN Commands:",
                )
                ...
                _add_examples(
                    [
                        (
                            "search police 10",
                            "Search for 'police' datasets, limit to 10 results",
                        ),
                        (
                            "package info london-crime",
                            "Show details for package named 'london-crime'",
                        ),
                    ]
                )
            ...
            case OpenDataSoftCatExplorer():
                ...
                _add_command_section(
                    [
                        ...
                        (
                            "dataset export <id>",
                            "Show available export formats for a dataset",
                        ),
                        (
                            "load <id> <format> <api-key>",
                            "Load a data sample into a DataFrame. Api-key is optional.",
                        ),
                    ],
                ...
                _add_examples(
                    [
                        (
                            "dataset info power-consumption",
                            "Show details for dataset 'power-consumption'",
                        ),
                        (
                            "dataset export energy-data",
                            "Show export formats for 'energy-data'",
                        ),
                    ]
                )
            ...
            case FrenchGouvCatExplorer():
                ...
                _add_examples(
                    [
                        (
                            "dataset meta 123abc",
                            "Show metadata for dataset with ID '123abc'",
                        ),
                        (
                            "resource meta 123abc res456",
                            "Show metadata for resource 'res456' in dataset '123abc'",
                        ),
                    ]
                )
            ...
            case None:
                ...
                output.append(
                    "Use 'show catalogs' to see available catalogs, then connect to one:\n",
                    style=Style(color="white"),
                )
                _add_examples(
                    [
                        (
                            ...
                            "Connect to the London Data Store",
                        ),
